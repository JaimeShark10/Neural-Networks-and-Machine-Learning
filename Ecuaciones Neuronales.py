...
class OLN:
    ...
    def __init__(self, n_inputs, n_outputs, activation_function=linear):
        self.w = -1 +2 * np.rand(n_outputs, n_inputs)
...
#Crearemos una función, y pasamos de logistic - softmax
#funcion contourf para llenar el fondo de las áreas: necesitaremos
#tres datos ordenados en (xx,yy,zz)